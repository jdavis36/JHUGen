...
(version v7.5.7, release date December 20, 2024) \\
\normalsize
\end{center}
...
\begin{verbatim}
  ...
  Process configuration:
    ...
    Process:           0=spin-0, 1=spin-1, 2=spin-2 resonance,
                       ...
                       117=t/tbar+W+H
    Polarization:      fL = (-1, 1) fPerp = (-1, 1) 
                       Polarization of spin 0 resonance. 
                       When calc_fL=1, fL and fPerp can be real number from -1 to 1.
                       When calc_fL=2, fL = 0 or 1, fPerp =0. 
                       Need to set with calc_fL at the same time.
                       calc_fL = 0, 1, 2
                       calc_fAmp = -1, 1, 2, -11 
                       Polarization of spin 2 resonance. 
                       -1 is spin 1- projection. 
                       1 is spin 1+ projection. 
                       2 is spin 2+ projection. 
                       -11 is interference between spin 1+ and spin 1-.
